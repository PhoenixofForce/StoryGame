/* tslint:disable */
/* eslint-disable */
// Generated using typescript-generator version 3.2.1263 on 2026-05-22 15:57:15.

export interface BaseMessage {
    type: "BaseMessage" | "join" | "lobby-change" | "submit_story" | "request_reveal" | "start_game" | "request_state" | "story_game_update" | "ping";
    message: string;
    error: boolean;
}
...
export type BaseMessageUnion = PlayerJoinMessage | LobbyStateMessage | SubmitStoryMessage | RequestRevealMessage | StartGameTrigger | RequestStateTrigger | StoryGameState | Ping;
