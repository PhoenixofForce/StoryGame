<script lang="ts">
  ...
  let storyEnd = "Dictum sit amet justo donec enim diam vulputate ut pharetra. Ultrices neque ornare aenean euismod elementum nisi quis. At tempor commodo ullamcorper a. Sagittis orci a scelerisque purus.";
  let story = "";
...
<div class="flex">
  ...
  <div class="right-column">
    ...
    <div class="buttons">
      ...
      <button disabled={story}>Edit</button>
    </div>
  </div>
</div>
